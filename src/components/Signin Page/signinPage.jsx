...
const SigninPage = () => {
  ...
  function getWallet(){
    ...
    if (isConnected) {
      ...
      {
        setConnectRainbow(false)
        setErrorMessage("Your connected wallet is not integrated with provided email.");
      }
  ...
  function signin() {
    ...
    axios
      .post(`${global.backendUrl}/signin`, formData)
      .then((response) => {
        ...
        {connectRainbow == false ?
          <div className="signin-form">
            ...
            <div className="email-input-container">
              ...
              <input value={email} type="email" placeholder="example@gmail.com" onChange={(e) => {
            ...
            <div className="password-input-container">
              ...
              <input value={password} type="password" placeholder="......." onChange={(e) => {
            ...
            <p>
              Don't have a community account? <Link className="signupLink" to="/Connectwallet"><strong > Sign Up</strong></Link>
            </p>
          </div>
          : <RainbowApi />}
      </div>
