...
const MyProfile = () => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      setProfileData(JSON.parse(sessionStorage.getItem("user")));
    }
  }, []);
    ...
    <div className="other_users_profile_main_container">
      <div style={{ overflow: "auto" }}>
        <div className="other_users_profile_container">
          <div className="transparent_head">
            <div>
              <h4>My Profile</h4>
            </div>
            <div>
              <Link to="/profilesetting" className="edit_profile_btn">
                <img src={EditIcon} alt="" className="me-1" /> Edit Profile
              </Link>
            </div>
          </div>
          <div className="d-flex user_profile_info">
            <div className="user_profile_img_container">
              <img
                ...
                src={
                  profileData != ""
                    ? `${global.backendUrl}/nodeassets/${profileData.user_image}`
                    : ""
                }
            ...
            <div className="user_profile_followers_container">
              <h3>{profileData != "" ? profileData.user_name : ""}</h3>
          ...
          <div className="user_interests_container">
            ...
            <div className="user_interests">
              <div className="user_interests_items">
                {profileData != "" ? profileData.user_interests != "" ?
                  JSON.parse(profileData.user_interests).map((item, index) => {
                    return (
                      <div
                      ...
                      >
                        <img
                          src={item === "Investing" ? MoneyIcon 
                            : item === "Front-end" ? CodeIcon 
                            : item === "Literature" ? MemoryIcon 
                            : item === "Back-end" ? WebDevIcon 
                            : item === "Teaching" ? EducationIcon 
                            : item === "Ui/Ux" ? UIUXIcon 
                            : item === "Art" ? ArtIcon 
                            : item === "Law" ? LawIcon : MoneyIcon
                          }
                          alt=""
                          // onClick={toggleSelectedItem}
                          data-id={index}
