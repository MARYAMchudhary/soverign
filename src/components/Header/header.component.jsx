...
const Header = () => {
  ...
  useEffect(() => {
    if (window.location.pathname === "/") {
      ...
      setBackground("aboutpage-bg");
    } else {
      setBackground("otherpages-bg");
    }
  ...
  return (
    ...
    >
      ...
      <div
        style={{ backgroundColor: "#1D1D1D", width: "250px" }}
        class={`offcanvas offcanvas-start ${showState}`}
        tabindex="-1"
        id="offcanvasExample"
        ...
        <div class="offcanvas-body">
          ...
          <div className="social-icons-for-hamburger">
            <Link to="/Connectwallet">
              <img src={MessageIcon} alt="" className="hambrger-social" />
            </Link>
            <a href="https://twitter.com/SVRNDAO" target="_blank">
              <img src={TwitterIcon} alt="" className="hambrger-social" />
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="sidenav">
        ...
        <div className="sidenav-social-icons d-none d-sm-flex">
          <Link to="/Connectwallet">
            <img src={MessageIcon} className="navsvg" alt="Icon" />
          </Link>
          <a href="https://twitter.com/SVRNDAO" target="_blank">
            <img src={TwitterIcon} className="navsvg" alt="Icon" />
          </a>
        </div>
      </div>
      <div className="right-side-container">
        <div className="top-nav justify-content-start justify-content-sm-between">
          ...
          <div className="site-name-container ms-sm-5">
            <Link to="/" style={{ textDecoration: "none" }}>
              <h1 className="site-name"> SOVEREIGN</h1>
              {/* <img
                    ...
                    >
                      ...
                      >
                        <div className="col-12">
                          <span style={{ borderRadius: "6px", color: "#fff" }}>
                            My Profile
                          </span>
                        </div>
                      </div>
